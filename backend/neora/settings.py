...
# Add whitenoise to middleware (add this line after SecurityMiddleware)
MIDDLEWARE = [
...
# Uses PostgreSQL when POSTGRES_* environment variables are set; falls back to SQLite otherwise
